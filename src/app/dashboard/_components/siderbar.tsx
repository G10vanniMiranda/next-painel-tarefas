...
const navItems = [
    ...
    { href: "/dashboard/tarefa1", label: "Tarefa 1", icon: Folder },
    { href: "/dashboard/tarefa2", label: "Tarefa 2", icon: Folder },
    { href: "/dashboard/tarefa3", label: "Tarefa 3", icon: Folder },
    { href: "/dashboard/tarefa4", label: "Tarefa 4", icon: Folder },
    { type: 'separator' },
    { type: 'title', label: 'Configurações' },
    { href: "/", label: "Futuro 1", icon: Settings },
    { href: "/", label: "Futuro 2", icon: Banknote },
]
